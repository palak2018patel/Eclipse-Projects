...
public class Practicescanner  {
	...
	public static void main(String[] args) {
		...
		if (m<50) {
			System.out.println("Result is Fail for marks: " +m);}
			else if(m>=50 && m<60) {
					System.out.println("Result is Pass for marks: " +m);}
				else if(m>=60 && m<70) {
						System.out.println("Result is Second class for marks: "+m);}
					else if	(m>=70 && m<80) {
						System.out.println("Result is First Class for marks: "+m);}
					else if (m>=80 && m<90) {
							System.out.println("Result is Distinction for marks: "+m);}
						else if (m>=90 && m<=100) {
								System.out.println("Result is Topper Rank for marks: "+m);}
							else {
...
String G="Female";
	...
	if(G==g) System.out.println("The person is a female");

	else System.out.println("The person is a male.");

	
	if(I==c) System.out.println(" The person is an adult  and has voting rights");
	else	
		System.out.println("The person doesnot have voting rights");
	}
