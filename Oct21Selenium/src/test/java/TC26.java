...
public class TC26 {
	...
	public static void main(String[] args) throws InterruptedException{
		WebDriverManager.chromedriver().setup();
		 ...
		 test=extent.createTest("createNewViewInContact_TC26");
		 System.out.println(" creating report..................................");	   
		 
		 TC26.createNewViewInContact_TC26();;		 
		 extent.flush();  		 
			
		 action=new Actions(driver);	

	}
	public static void createNewViewInContact_TC26() throws InterruptedException{
		...
		viewName.clear();
		Thread.sleep(5000);	
		viewName.sendKeys("Palak_Patel01");
		...
		Thread.sleep(9000);	
		viewUniqueName.sendKeys("PPatel01");
		//driver.findElement(By.xpath("")).sendKeys();
		System.out.println("Clicked on ViewUnique Name and entered unique name");
		
		Thread.sleep(5000);	
		driver.findElement(By.xpath("//input[(@title='Save')]")).click();
		System.out.println("Clicked on save button");
		
		driver.findElement(By.xpath("//form[(@id=\"00B5f00000E6E1U_actionForm\")]")).isDisplayed();
