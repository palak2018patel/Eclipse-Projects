...
public class TC29 {
	...
	public static void main(String[] args) throws InterruptedException{
		...
		WebDriverManager.chromedriver().setup();
		 ...
		 test=extent.createTest("ViewAcontact_TC29");
		 System.out.println(" creating report..................................");	   
		 
		 TC29.ViewAcontact_TC29();		 
		 extent.flush();  
	...
	public static void ViewAcontact_TC29() throws InterruptedException{
		...
		Thread.sleep(5000);	
		driver.findElement(By.xpath("//a[(@href='/0035f000007YIUK')]")).click();
		System.out.println("Clicked on a contact name in the name field in Recent contact frame");
