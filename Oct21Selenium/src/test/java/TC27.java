...
public class TC27 {
	...
	public static void main(String[] args) throws InterruptedException {
		WebDriverManager.chromedriver().setup();
		 ...
		 test=extent.createTest("checkRecentlyCreatedContact_TC27");
		 System.out.println(" creating report..................................");	   
		 
		 TC27.checkRecentlyCreatedContact_TC27();;		 
		 extent.flush();  
		 
		 action=new Actions(driver);	
	}

	public static void checkRecentlyCreatedContact_TC27() throws InterruptedException{
		...
		System.out.println("Clicked on Recent dropdown list ");
		
		Thread.sleep(5000);	
		driver.findElement(By.xpath("//*[@id=\"hotlist_mode\"]/option[1]")).click();
		System.out.println("Clicked on Recently created Contact ");
