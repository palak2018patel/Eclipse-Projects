...
public class TC2 {
	 ...
	 public static void main(String[] args) throws InterruptedException{
		 ...
		 test=extent.createTest("loginToSalesForce_TC2");
		 System.out.println(" creating report..................................");	   
		 
		 TC2.loginToSalesForce_TC2();		 
		 extent.flush();  
		 
		 
	}	 
	public static void loginToSalesForce_TC2() throws InterruptedException{
		...
		driver.findElement(By.id("ForceCom_font"));
