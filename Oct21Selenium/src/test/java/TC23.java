...
public class TC23 {
	...
	public static void main(String[] args) throws InterruptedException{
		 ...
		 test=extent.createTest("TodaysLeads_TC23");
		 System.out.println(" creating report..................................");	   
		 
		 TC23.TodaysLeads_TC23();			 
		 extent.flush(); 	 
		
		 action=new Actions(driver);	

	}
	public static void TodaysLeads_TC23() throws InterruptedException{
		...
		//Thread.sleep(9000);	
		//driver.findElement(By.xpath("//*[@id=\"00B5f00000Bs0xo_listSelect\"]/option[4]")).click();
		System.out.println("clicked on Today's Lead from drop down");  //preselected manually as auto didnot work
		...
		//not working//driver.findElement(By.xpath("//div[(@id=\"wrapper\")]")).isDisplayed();
		//not working//driver.findElement(By.id("username")).isDisplayed();
